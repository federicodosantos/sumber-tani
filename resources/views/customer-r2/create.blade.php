<x-app-layout>
    <div class="py-12 font-mont">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <x-content.form-card action="{{ route('customer-r2.store') }}" method="POST">
                @csrf
                <x-slot:leftCol>
                    <x-content.form-input label="Nama Pelanggan" name="name" placeholder="Masukkan nama pelanggan"
                        required />
                    <x-content.form-input label="Nomor Kontak" name="phone_number" placeholder="08xxxxxxxxxx" required />
                </x-slot:leftCol>

                <x-slot:rightCol>
                    <x-content.form-input label="Alamat" name="address" placeholder="Masukkan alamat pelanggan"
                        required />
                </x-slot:rightCol>
