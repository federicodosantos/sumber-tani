                    ...
                    <div class="rounded-xl border border-gray-200 bg-gray-50 px-5 py-4 sm:min-w-[220px]">
                        ...
                        @if ($totalDebt > 0)
                            <button @click="$dispatch('open-modal', 'pay-debt')"
                                class="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-button-main px-4 py-3 text-xs font-bold text-white transition-colors hover:bg-button-hover cursor-pointer shadow-sm active:scale-[0.98]">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            ...
                            <div class="text-right flex flex-col items-end gap-2">
                                ...
                                <button @click="$dispatch('open-modal', 'preview-invoice-{{ $invoice->id }}')"
                                    class="inline-flex items-center gap-1.5 rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-xs font-semibold text-gray-700 transition-colors hover:bg-gray-50 hover:border-gray-400 cursor-pointer">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                ...
                                <x-modal name="preview-invoice-{{ $invoice->id }}" title="PREVIEW NOTA #{{ $invoice->id }}" maxWidth="2xl">
                                    <div class="p-1">
                                    ...
                                    <div class="p-4 border-t border-gray-100 flex justify-end gap-3 bg-gray-50">
                                        ...
                                        <a href="{{ route('customer-r2.invoice.preview', $invoice->id) }}" target="_blank"
                                            class="inline-flex items-center gap-2 rounded-lg bg-button-main px-4 py-2 text-sm font-bold text-white hover:bg-button-hover transition-colors">
