...
@section('content')
    ...
    <x-content.data-table>
                ...
                <tr class="hover:bg-gray-50/50">
                    ...
                    <td class="max-w-sm px-6 py-4 text-sm text-gray-600">
                        <span class="line-clamp-2">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris fringilla finibus eros
        ...
        <x-slot name="pagination">
            ...
            <a href="#"
                class="inline-flex h-8 w-8 items-center justify-center rounded-md border border-gray-300 bg-white text-sm text-gray-700
                hover:bg-gray-50">
                26
            </a>
            <a href="#"
